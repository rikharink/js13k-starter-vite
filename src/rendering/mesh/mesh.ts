import { GL_ARRAY_BUFFER, GL_ELEMENT_ARRAY_BUFFER, GL_STATIC_DRAW, GL_TRIANGLES, GL_UNSIGNED_SHORT } from "../../gl-constants";
...
export abstract class Mesh {
    ...
    protected constructor(gl: WebGL2RenderingContext, vertices: Float32Array, indices: Uint16Array, material: Shader) {
        ...
        const coord = gl.getAttribLocation(material.program, "vertexPosition");
